...
public class Player extends Sprite {
	...
	/**
	  * draws the player as the sprite loaded in, if no sprite a cyan rectangle  of the same size
	  * @param g2
	  */
	...
	// returns the x position of player
	public int getX() {
		return x;
	}
	...
	/**
	 * update checks if the player is on a platform and if not, makes the player
	 * fall.
	 * 
	 * @param p
	 */
